...
public class ApolloTest {
    ...
    public void setTheStartingPositions(){
        ...
        turnManager = BoardGameConstructor.construct(new String[]{"Alpha","Beta"}, new int[]{-2,-2});
        ...
        rule =new Apollo(turnManager.getBoard(), turnManager.getPlayer()[0]);
    ...
    public void forceMoveOpponent(){
        ...
        Assert.assertTrue(Arrays.equals(turnManager.getPlayer()[1].getWorker(1).getPosition(), turnManager.getPlayer()[0].getWorker(1).getPosition()));
    }
}
