...
import model.Demetra;
import model.TestActionProvider;
import org.junit.Assert;
import org.junit.Before;
import org.junit.Test;

public class DemetraTest {
        ...
        public void testBuild(){
            ...
            Assert.assertTrue(turnManager.getPlayer()[0].getDeity() instanceof Demetra);
    ...
    public void twoFailedBuilds(){
        ...
        BuildingAction[] actions = new BuildingAction[]{new BuildingAction(new int[]{3,2}),new BuildingAction(new int[]{2,2}),new BuildingAction(new int[]{2,2}),new BuildingAction(new int[]{2,3})};
        TestActionProvider.getProvider().setBuildingActions(actions);
